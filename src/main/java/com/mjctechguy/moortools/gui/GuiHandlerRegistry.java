 ...
 * Each of the examples, with its own GuiHandlerMTFurnace, registers itself with the GuiHandlerRegistry.
 * When GuiHandlerRegistry receives a call from Forge, it passes it to the appropriate example's GuiHandlerMTFurnace.
 */
